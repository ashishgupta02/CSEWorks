...
public class LZMACompress {
  ...
  // Done
  //-----------------------------------------------------------------------------------------------
  public static boolean Encode(InStream inStream, OutStream outStream) throws Exception {
  ...
  // Done
  //-----------------------------------------------------------------------------------------------
  public static boolean Encode(InStream inStream, OutStream outStream, Params param) throws Exception {
    Encoder encoder = new Encoder();
