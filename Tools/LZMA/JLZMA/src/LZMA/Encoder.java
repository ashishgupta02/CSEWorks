...
public class Encoder {
  ...
  class LenPriceTableEncoder extends LenEncoder {
    ...
    //-----------------------------------------------------------------------------------------------
    @Override
    public void Encode(RangeCoder.RangeEncoder rangeEncoder, int symbol, int posState) throws IOException {
  ...
  // Done
  //-----------------------------------------------------------------------------------------------
  void SetOutStream(OutStream outStream) {
  ...
  // Done
  //-----------------------------------------------------------------------------------------------
  void SetStreams(InStream inStream, OutStream outStream,
  ...
  // Done
  //-----------------------------------------------------------------------------------------------
  public void WriteCoderProperties(OutStream outStream) throws IOException {
